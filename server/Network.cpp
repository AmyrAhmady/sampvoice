...
bool Network::Init(ICore* ompCore) noexcept
{
...
std::array<std::atomic_bool, PLAYER_POOL_SIZE> Network::playerStatusTable{};
std::array<std::shared_ptr<sockaddr_in>, PLAYER_POOL_SIZE> Network::playerAddrTable{};
std::array<uint64_t, PLAYER_POOL_SIZE> Network::playerKeyTable{};
...
SPSCQueue<Network::ControlPacketInfo> Network::controlQueue{ 32 * PLAYER_POOL_SIZE };
